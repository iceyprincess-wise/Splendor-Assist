            ...
            currentFuture = warmupExecutor.submit {
                ...
                try {
                    val allContributors = listOf<GameplayContributor>(
                        ...
                        com.assistant.contributors.MagneticFeetContributor,
                        com.assistant.contributors.PassingContributor,
                        com.assistant.contributors.SupportContributor,
                        com.assistant.contributors.DefenseContributor,
                        com.assistant.contributors.EvadeContributor,
                        com.assistant.contributors.AttackingVectorContributor,
                        com.assistant.contributors.CrossContributor,
                        com.assistant.contributors.AgilityContributor,
                        com.assistant.contributors.WingBlockContributor,
                        com.assistant.contributors.DashPressureContributor,
                        com.assistant.contributors.InterceptMatrixContributor,
                        com.assistant.contributors.TouchRecoveryContributor,
                        com.assistant.contributors.OverloadPlaystyleContributor,
                        com.assistant.contributors.TruePassContributor,
                        com.assistant.contributors.ReceiverEngagementContributor,
                        com.assistant.contributors.ForwardRunContributor,
                        com.assistant.contributors.ShotOpportunityContributor,
                        com.assistant.contributors.DefenseAuthorityContributor,
                        com.assistant.contributors.ShotAnticipationContributor,
                        com.assistant.contributors.KeeperFeedbackContributor,
                        com.assistant.contributors.DashAnchorContributor,
                        com.assistant.contributors.SpeedCompensationContributor,
                        com.assistant.contributors.InstantInterceptContributor,
                        com.assistant.contributors.BuildUpPressContributor,
                        com.assistant.contributors.BallRetentionShieldContributor,
                        com.assistant.contributors.TrueShotContributor,
                        com.assistant.contributors.TrueCrossContributor,
                        com.assistant.contributors.SmartAssistUltimateCorrectorContributor,
                        com.assistant.contributors.SharpTouchTimingContributor,
                        com.assistant.contributors.KickingPostureContributor
                    )
