    ...
    companion object {
        ...
        private fun probeFeatures(ctx: Context): String {
            ...
            val engines = listOf(
                ...
                EngineEntry("MagneticFeetContributor","com.assistant.MagneticFeetContributor","ACTIVE","vision-backed possession movement assist; bounded MOVE contribution"),
                ...
                EngineEntry("PassingContributor","com.assistant.PassingContributor","ACTIVE","fires when viable pass lanes exist"),
                EngineEntry("CrossContributor","com.assistant.CrossContributor","ACTIVE","fires on crossing lane detection"),
                EngineEntry("DefenseContributor","com.assistant.DefenseContributor","ACTIVE","fires when !hasBall and defenders threatening"),
                EngineEntry("InstantInterceptContributor","com.assistant.InstantInterceptContributor","ACTIVE","0-delay intercept on opponent proximity"),
                EngineEntry("BuildUpPressContributor","com.assistant.BuildUpPressContributor","ACTIVE","build-up press when opponent in possession"),
                EngineEntry("BallRetentionShieldContributor","com.assistant.BallRetentionShieldContributor","ACTIVE","shield on possession + pressure"),
                EngineEntry("SpeedCompensationContributor","com.assistant.SpeedCompensationContributor","ACTIVE","reads all bus signals for duration scaling"),
                EngineEntry("TrueShotContributor","com.assistant.TrueShotContributor","ACTIVE","high-accuracy shot with keeper bias"),
                EngineEntry("TrueCrossContributor","com.assistant.TrueCrossContributor","ACTIVE","precision cross delivery"),
                EngineEntry("TruePassContributor","com.assistant.TruePassContributor","ACTIVE","true target passing with receiver prediction"),
                EngineEntry("SmartAssistUltimateCorrectorContributor","com.assistant.SmartAssistUltimateCorrectorContributor","ACTIVE","ultimate corrector — last-resort normalizer"),
                EngineEntry("KeeperFeedbackContributor","com.assistant.KeeperFeedbackContributor","ACTIVE","goalkeeper real-position feedback"),
                EngineEntry("AgilityContributor","com.assistant.AgilityContributor","ACTIVE","agility-based movement contributor"),
                EngineEntry("AttackingVectorContributor","com.assistant.AttackingVectorContributor","ACTIVE","attacking vector director"),
                EngineEntry("ForwardRunContributor","com.assistant.ForwardRunContributor","ACTIVE","forward run opportunity contributor"),
                EngineEntry("TouchRecoveryContributor","com.assistant.TouchRecoveryContributor","ACTIVE","ball retention touch recovery"),
                EngineEntry("InterceptMatrixContributor","com.assistant.InterceptMatrixContributor","ACTIVE","defensive intercept matrix"),
                EngineEntry("DashAnchorContributor","com.assistant.DashAnchorContributor","ACTIVE","dash anchor with pressure fallback"),
                EngineEntry("DashPressureContributor","com.assistant.DashPressureContributor","ACTIVE","dash under defensive pressure"),
                EngineEntry("ShotOpportunityContributor","com.assistant.ShotOpportunityContributor","ACTIVE","shot opportunity analyzer"),
                EngineEntry("DefenseAuthorityContributor","com.assistant.DefenseAuthorityContributor","ACTIVE","defensive authority claim"),
                EngineEntry("ShotAnticipationContributor","com.assistant.ShotAnticipationContributor","ACTIVE","shot anticipation keeper response"),
                EngineEntry("ReceiverEngagementContributor","com.assistant.ReceiverEngagementContributor","ACTIVE","receiver engagement for passing"),
                EngineEntry("OverloadPlaystyleContributor","com.assistant.OverloadPlaystyleContributor","ACTIVE","overload playstyle contributor"),
                EngineEntry("WingBlockContributor","com.assistant.WingBlockContributor","ACTIVE","wing block defensive contributor"),
                EngineEntry("EvadeContributor","com.assistant.EvadeContributor","ACTIVE","evade/dodge contributor"),
                EngineEntry("SupportContributor","com.assistant.SupportContributor","ACTIVE","support movement contributor"),
