...
def apply_phase_a_capture_ownership():
    file_path = "app/src/main/java/com/assistant/OverlayService.kt"
    
    # Phase A - Capture Ownership & State Machine Upgrade
...
"""
    ...
    try:
        ...
        print(f"SUCCESS: Phase A Capture Ownership applied perfectly to {file_path}")
    except Exception as e:
        print(f"FATAL: Failed to write {file_path} - {e}")
        sys.exit(1)

if __name__ == "__main__":
    apply_phase_a_capture_ownership()
